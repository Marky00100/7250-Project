...
for bachelor recipients by CIPs. The size of each dot is representative of the median wage, binned, compared to other occupations. The color shows the gap ratio for that SOC code in 2022, Ohio, bachelors. In this way, dots found in the top left quadrant are coparatively less saturated occupations for Ohio bachelor degree precipitants in 2022. This could be used as a rough start for interested students to find their field of interest and associated CIP titles, and see where those titles fall in the quadrant, the size of the dot, and gap ratio (both by the dot's position and color of the dot itself). This could be modified to apply to whichever JobsOhio region a college entrant may find themselves in. 
